...
var camera = initCamera(new THREE.Vector3(0, 10, -40)); // Init camera in this position
...
function createVehicle(pos, quat) {
	...
	rollInfluence = 10.2;
		...
		wheelAxisHeightBack = 0.15;
	
		wheelAxisFrontPosition = 1.6;
		wheelAxisPositionBack = -1.3;



	addWheel(true, new Ammo.btVector3(wheelHalfTrackFront, wheelAxisHeightFront, wheelAxisFrontPosition), wheelRadiusFront, wheelWidthFront, FRONT_LEFT);
	addWheel(true, new Ammo.btVector3(-wheelHalfTrackFront, wheelAxisHeightFront, wheelAxisFrontPosition), wheelRadiusFront, wheelWidthFront, FRONT_RIGHT);
	addWheel(false, new Ammo.btVector3(-wheelHalfTrackBack, wheelAxisHeightFront, wheelAxisPositionBack), wheelRadiusBack, wheelWidthBack, BACK_LEFT);
	addWheel(false, new Ammo.btVector3(wheelHalfTrackBack, wheelAxisHeightFront, wheelAxisPositionBack), wheelRadiusBack, wheelWidthBack, BACK_RIGHT);
